...
warden::ModuleProfile const ModuleWin8606 =
{
    // Module identities and rekey values belong to the delivered module. The
    // callback RVAs below are independently recovered from exact build 8606.
    8606,
    "Win",
    ...
    std::string const& platform) const
{
    ...
    // future absolute checks remain exact to build 8606.
